...
| 12 | Fluxmania V - Text2Image | 3 | 2 | 0 | 1 | 2 |
...
| Model | Type | Reason |
|-------|------|--------|
| Juggernaut_X_RunDiffusion.safetensors | checkpoint | No URL found in any source |
...
|-------|--------|-------|-----|
| EldritchDigitalArt1.3.safetensors | civitai | HTTP 403 | `https://civitai.com/api/download/models/14856` |
...
|-------|--------|-------|-----|
| ae.safetensors | workflow | HTTP 403 | `https://huggingface.co/black-forest-labs/FLUX.1-sc...` |
| clipLCLIPGFullFP32_zer0intVisionCLIPL.safetensors | civitai | HTTP 403 | `https://civitai.com/api/download/models/9208` |

### txt2ImgLORA

| Model | Source | Error | URL |
|-------|--------|-------|-----|
| juggernautXL_ragnarokBy.safetensors | civitai | HTTP 403 | `https://civitai.com/api/download/models/965389` |
| Pony Realism Slider.safetensors | civitai | HTTP 403 | `https://civitai.com/api/download/models/2632225` |
